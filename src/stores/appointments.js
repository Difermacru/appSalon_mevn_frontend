...
export const useAppointmentsStore = defineStore('appointments', ()=>{
    ...
    watch(date, async () => {
        ...
        //se obtienen todas las citas disponibles
    ...
    async function saveAppointment(){
        ...
        if(appointmentId.value){
            ...
            user.getUserAppointments()//sirve para refrescar la pagina y aparezcan las actualizaciones
    ...
    //el boton que esta en AppointmentView.vue se mostrara solo si estan llenas estas constantes
